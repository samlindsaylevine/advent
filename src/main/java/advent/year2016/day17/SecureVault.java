...
public class SecureVault {
	...
	public static class Path {
		...
		private static final List<Direction> DOOR_HASH_ORDER = ImmutableList.of(Direction.U, Direction.D, Direction.L, Direction.R);
	...
	private static enum Direction {
		...
		// By convention these are both towards the goal.
	...
	public static void main(String[] args) {
		System.out.println(new SecureVault("rrrbmfta").shortestPathToExit().get());;
	}
