 ...
 * "Situation critical," the device announces. "Destination indeterminate. Chronal interference detected. Please
 ...
 * 32, that location is within the desired region. Using the same coordinates as above, the resulting region looks like
 * this:
 * ..........
 * .A........
 * ..........
...
class ChronalCoordinates(private val coordinates: Set<Point>) {
  ...
  private val minX = coordinates.map { it.x }.minOrNull() ?: 0
  private val maxX = coordinates.map { it.x }.maxOrNull() ?: 0
  private val minY = coordinates.map { it.y }.minOrNull() ?: 0
  private val maxY = coordinates.map { it.y }.maxOrNull() ?: 0
