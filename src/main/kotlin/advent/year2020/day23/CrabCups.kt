 ...
 * then start counting up from 6 until one million is reached.) In this way, every number from one through one million
 * is used exactly once.
 * After discovering where you made the mistake in translating Crab Numbers, you realize the small crab isn't going to
 * do merely 100 moves; the crab is going to do ten million (10000000) moves!
