 ...
 * other Elves that it would be okay to give you their one malfunctioning device - surely you'll have no problem fixing
 * it.
...
fun main() {
  val input = File("src/main/kotlin/advent/year2022/day6/input.txt").readText().trim()
  val signal = ElfCommunicationSignal(input)

  println(signal.firstMarker(4))
  println(signal.firstMarker(14))
}