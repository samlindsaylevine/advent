 ...
 * cave. As you do, you notice a collection of geodes around the pond. Perhaps you could use the obsidian to create
...
class RobotFactoryBlueprint(
  ...
  fun maxProducible(type: String = "geode", time: Int = 24): Int {
    val possibilities = PriorityQueue(
      100,
      // Depth-first search - look at ones near the end of their time first. (This lets us discard ones that can't beat
      // our current record more quickly, maybe?)
    ...
    while (possibilities.isNotEmpty()) {
      ...
      // Prune this if it can't possibly beat our current best result. Need this extra pruning to be able to run fast
      // enough.
      ...
      // turns. Obviously may not be possible, but guaranteed can't do better than this.
