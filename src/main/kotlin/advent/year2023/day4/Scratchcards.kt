 ...
 * by water, not the floating kind. We really need to come up with a better naming scheme. Tell you what: if you can
 * help me with something quick, I'll let you borrow my boat and you can go visit the gardener. I got all these
 ...
 * 6, 31, 17, 9, 48, and 53). Of the numbers you have, four of them (48, 83, 17, and 86) are winning numbers! That
 * means card 1 is worth 8 points (1 for the first match, then doubled three times for each of the three matches after
 * the first).
 *
 ...
 *
 */
class Scratchcards(private val cards: List<Scratchcard>) {
