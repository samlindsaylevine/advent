...
class FactoryMachineTest {
  ...
  @Test
  fun `minimum button presses -- first example -- 2`() {
    val machine = FactoryMachine.of("[.##.] (3) (1,3) (2) (2,3) (0,2) (0,1) {3,5,4,7}")

    val presses = machine.minimumButtonPresses()

    assertThat(presses).isEqualTo(2)
  }

  @Test
  fun `minimum button presses -- second example -- 3`() {
  ...
  @Test
  fun `minimum button presses -- third example -- 2`() {
